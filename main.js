...
var canvasPos = getPosition(document.getElementById("theCanvas"));
...
function convH(e){
  ...
  for(var i = 0 ; i< dots.length;i++){
    points.push(new Point(i,getPosition(dots[i]).x,getPosition(dots[i]).y));
  }
  if(dots.length == 1){
    return 0;
  }
...
canvas.onmouseup = function(e){
  if(document.getElementById("listOfPoints").childElementCount >=2){
    //  var posPoint0= document.getElementById("point0").getBoundingClientRect();
    //var posPoint1= document.getElementById("point1").getBoundingClientRect();
    //var canvasPos= document.getElementById("theCanvas").getBoundingClientRect();

    var posPoint0= getPosition(document.getElementById("point0"));
    var posPoint1= getPosition(document.getElementById("point1"));
